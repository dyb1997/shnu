...
from speechbrain.dataio.dataloader_class import FewShotDataloader
    ...
    def fit(
        ...
        * ``update_average()``
        ...
        dloader_train = FewShotDataloader(
            ...
            nTestNovel=nTestNovel,  # num test examples for all the novel categories
            nTestBase=nTestBase,  # num test examples for all the base categories
            batch_size=batch_size,
            num_workers=num_workers,
            epoch_size=epoch_size,
            phase = "train"# num of batches per epoch
        )
        self.on_fit_start()
