    ...
    def fit_batch(self, batch):
        ...
        * ``compute_objectives()``
        ...
        if self.auto_mix_prec:
            ...
            outputs_T, outputs_S, len_T, len_S ,embedding_T,embedding_S,A_T,A_S= self.compute_forward(batch, sb.Stage.TRAIN)
            loss = None
            ...
            consistency_cost2 = (self.max_consistency_cost+1)*self.rampup_value
