...
# DEFAULT_LOAD_HOOKS2 = {
#     torch.nn.Module2: torch_recovery,
#     # torch.optim.Optimizer2: torch_recovery,
#     # torch.optim.lr_scheduler2._LRScheduler: torch_recovery,
#     # torch.optim.lr_scheduler.ReduceLROnPlateau: torch_recovery,
# }
DEFAULT_SAVE_HOOKS = {
...
def register_checkpoint_hooks2(cls):
    """Class decorator which registers the load, save and transfer hooks.
...
class Checkpointer:
    ...
    def __init__(
        ...
        allow_partial_load=True,
            #allow_partial_load如果为 True，则允许加载一个检查点，其中没有为每个已注册的可恢复文件找到保存文件。
    ):
