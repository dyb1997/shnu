...
class Brain:
    ...
    * ``evaluate_batch()``
    ...
    def __init__(  # noqa: C901
        ...
        for param in modules2.parameters():
            param.detach_()
        ...
        * ``compute_objectives()``
        ...
        if self.auto_mix_prec:
            ...
            if loss is not None:
                ...
                loss = loss2
            consistency_cost = 2 * self.rampup_value
            ...
            self.global_step += 1
            if self.modules2 is not None:
                self.update_ema_variables(self.modules, self.modules2, 0.999, self.global_step)
        ...
        for epoch in epoch_counter:
            ...
            with tqdm(
                ...
                for batch in t:
                    ...
                    self.rampup_value = self.exp_rampup(self.global_step,  4* len(train_set))
