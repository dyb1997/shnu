    ...
    def fit_batch(self, batch):
        ...
        * ``compute_objectives()``
        ...
        if self.auto_mix_prec:
            ...
            outputs_T,outputs_S,len_T,len_S,embeddings_T_sup,embeddings_S_sup,embeddings_T,embeddings_S,embeddings_T_sup2,embeddings_S_sup2= self.compute_forward(batch, sb.Stage.TRAIN)
            loss = None
            ...
            loss3 = self.loss_fn(embeddings_T_sup,embeddings_S_sup)
            loss3 = loss3.mean()
            #loss3 = self.MSE(outputs_T, outputs_S)
            ...
            loss4 = self.loss_fn(embeddings_T_sup2, embeddings_S_sup2)
            loss4= loss4.mean()
            # loss3 = self.MSE(outputs_T, outputs_S)
            print("student",loss4)
            ...
            if self.modules2 is not None:
                self.update_ema_variables(self.modules, self.modules2, 0.99, self.global_step)
