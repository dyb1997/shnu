...
workspace = ".."
# DESED Paths
data_folder: '/mnt/data3/dyb/voxmovies/vox_movies'
save_folder: os.path.join(workspace ,'results/ecapa_voxmoviestest/')
verification_pairs_file: '/mnt/data3/dyb/2021.12.16/speechbrain/recipes/VoxCeleb/SpeakerRec/results/ecapa_voxmovies/1986/save/veri_test2.txt'
