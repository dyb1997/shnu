...
class SpeakerBrain(sb.core2ASP.Brain):
    ...
    def compute_forward(self, batch, stage):
        ...
        embeddings_T,y_T,A_T = self.modules.embedding_model(feats_T)
        outputs_T = self.modules.classifier(embeddings_T)
        embeddings_S,y_S,A_S= self.modules2.embedding_model(feats_S)
        outputs_S = self.modules2.classifier(embeddings_S)
        # embeddings1 = self.modules.mean_var_norm_emb(embeddings_T)
        # embeddings2 = self.modules2.mean_var_norm_emb(embeddings_S)
        return outputs_T,outputs_S, len_T,len_S,embeddings_T,embeddings_S,y_T,y_S,A_T,A_S
...
if __name__ == "__main__":
    ...
    sb.core2ASP.create_experiment_directory(
