...
class SpeakerBrain(sb.coreseMFAA.Brain):
    ...
    def compute_forward(self, batch, stage):
        ...
        return outputs_T,outputs_S, len_T,len_S,embeddings_T,embeddings_S,y_T,y_S
...
if __name__ == "__main__":
    ...
    sb.coreseMFAA.create_experiment_directory(
