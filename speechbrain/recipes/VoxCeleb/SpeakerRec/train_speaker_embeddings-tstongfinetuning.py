...
class SpeakerBrain(sb.core22.Brain):
    ...
    def compute_forward(self, batch, stage):
        ...
        embeddings_S = self.modules2.embedding_model(feats_S)
    ...
    def compute_objectives2(self, predictions,lens, batch, stage):
        ...
        if stage != sb.Stage.TRAIN:
            self.error_metrics2.append(uttid, predictions, spkid, lens)
    ...
    def on_stage_end(self, stage, stage_loss, epoch=None):
        ...
        if stage == sb.Stage.TRAIN:
            ...
            stage_stats["ErrorRate2"] = self.error_metrics2.summarize("average")
        ...
        if stage == sb.Stage.VALID:
            ...
            self.checkpointer2.save_and_keep_only(
                meta={"ErrorRate": stage_stats["ErrorRate2"]},
                min_keys=["ErrorRate2"],
            )
...
if __name__ == "__main__":
    ...
    from voxceleb_prepare_finetuning import prepare_voxceleb  # noqa
    ...
    sb.core22.create_experiment_directory(
