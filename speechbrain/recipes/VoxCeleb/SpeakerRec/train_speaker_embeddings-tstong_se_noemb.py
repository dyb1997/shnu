...
class SpeakerBrain(sb.corese2.Brain):
    ...
    def compute_forward(self, batch, stage):
        ...
        print(len(embeddings_S))
        outputs_S = self.modules2.classifier(embeddings_S)
        embeddings1 = self.modules.mean_var_norm_emb(embeddings_T,torch.ones(embeddings_T.shape[0]).to(embeddings_T.device))
        print(len(embeddings1))
        embeddings2 = self.modules2.mean_var_norm_emb(embeddings_S,torch.ones(embeddings_S.shape[0]).to(embeddings_S.device))
        return outputs_T,outputs_S, len_T,len_S,embeddings1,embeddings2,y_T,y_S
...
if __name__ == "__main__":
    ...
    sb.corese2.create_experiment_directory(
